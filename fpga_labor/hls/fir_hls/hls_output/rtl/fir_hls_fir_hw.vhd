...
entity fir_hw_top_vhdl is
port (
	clk   :        in     std_logic;
	reset   :        in     std_logic;
	axi4target_arready   :        out    std_logic;
	axi4target_arvalid   :        in     std_logic;
	axi4target_araddr   :        in     std_logic_vector(12-1 downto 0);
	...
	axi4target_awaddr   :        in     std_logic_vector(12-1 downto 0);
...
architecture behavior of fir_hw_top_vhdl is

component fir_hw_top is
port (
	clk   :        in     std_logic;
	reset   :        in     std_logic;
	axi4target_arready   :        out    std_logic;
