...
entity bypass_hw_control_s_axi is
generic (
...
end entity bypass_hw_control_s_axi;
...
architecture behave of bypass_hw_control_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    constant ADDR_TLAST_DNUM_DATA_0 : INTEGER := 16#10#;
    constant ADDR_TLAST_DNUM_CTRL   : INTEGER := 16#14#;
