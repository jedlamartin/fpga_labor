...
export RDI_DATADIR="/xilinx/2025.2/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_22 -L zynq_ultra_ps_e_vip_v1_0_22 -L smartconnect_v1_0 -L xilinx_vip"
...
simulate()
{
  xsim cpu_system -key {Behavioral:sim_1:Functional:cpu_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_7c56.protoinst" -protoinst "protoinst_files/bd_38aa.protoinst" -protoinst "protoinst_files/bd_bc07.protoinst" -protoinst "protoinst_files/cpu_system.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/xilinx/2025.2/data/xsim"
  fi
