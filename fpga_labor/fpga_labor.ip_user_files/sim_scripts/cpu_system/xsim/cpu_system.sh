...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L zynq_ultra_ps_e_vip_v1_0_22 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L gigantic_mux -L xlconcat_v2_1_7 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cpu_system xil_defaultlib.cpu_system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cpu_system -key {Behavioral:sim_1:Functional:cpu_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_7c56.protoinst" -protoinst "protoinst_files/bd_38aa.protoinst" -protoinst "protoinst_files/cpu_system.protoinst" -log simulate.log
}
