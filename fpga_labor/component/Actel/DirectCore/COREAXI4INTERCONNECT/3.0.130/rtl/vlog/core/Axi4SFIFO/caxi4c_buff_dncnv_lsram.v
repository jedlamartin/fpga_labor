...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
  ...
  Copyright (c) 2020 Microchip, All rights reserved.
   ...
   ======================================================================
   Filename        : corejesd204c_txbuf_lsram.v
   Description     : Place holder for transmit CoreJESD204C Blocks with user data
                   :
   Author          :
   Date Created    : 26-07-2022
   Last Modified By: $Author: $
   Last Modified On: $Date: 2023-07-03 22:00:14 +0530 (Mon, 03 Jul 2023) $
   Modification    : $Revision: 43257 $
  * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
module caxi4c_buff_dncnv_lsram #(
  ...
  reg [MINWIDTH-1:0] ram [0:MAXSIZE-1]/* synthesis syn_raintryle = lsram */;
  genvar i;
