...
// SVN $Revision: 43847 $
// SVN $Date: 2023-08-22 01:07:17 +0530 (Tue, 22 Aug 2023) $
//
// Resolved SARs
...
module caxi4c_corefifo_sync_scntr (
    clk,
    //reset,
	aresetn,
	sresetn,
...
////////////////////////////////////////////
   ...
   generate
      ...
      // threshold values
      // --------------------------------------------------------------------------
	  assign afthreshi =  AF_FLAG_STATIC ? AFULL_VAL-1  : AF_DYN_EN ?  afull_in_dyn_thold - 1 :FULL_WRITE_DEPTH;
	  assign aethreshi =  AE_FLAG_STATIC ? AEMPTY_VAL : AE_DYN_EN ? aempty_in_dyn_thold  : 2;    //SAR#60185
   ...
   generate
      ...
      // threshold values
      // --------------------------------------------------------------------------
      assign afthreshi =  AF_FLAG_STATIC ? AFULL_VAL    : AF_DYN_EN ?  afull_in_dyn_thold : FULL_WRITE_DEPTH;     
      assign aethreshi =  AE_FLAG_STATIC ? AEMPTY_VAL : AE_DYN_EN ? aempty_in_dyn_thold   : 2;    //SAR#60185
