  ...
  generate
    ...
    begin  : txbuf_lsram
      ...
      begin : txbuf_uram
        ...
        caxi4pc_buff_dncnv_reg #( //FPGA Resources
          .W_DWIDTH( W_DWIDTH ),
          .W_MEM_SIZE ( W_MEM_SIZE ),
          .W_ADDRWIDTH ( W_ADDRWIDTH ),
          .R_DWIDTH ( R_DWIDTH ),
