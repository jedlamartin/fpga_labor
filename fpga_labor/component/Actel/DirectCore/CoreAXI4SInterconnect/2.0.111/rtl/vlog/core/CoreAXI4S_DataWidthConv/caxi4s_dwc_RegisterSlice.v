...
//
// File: caxi4s_dwc_RegisterSlice.v
//
// SVN Revision Information:
// SVN $Revision: 40494 $
// SVN $Date: 2022-04-22 20:31:25 +0530 (Fri, 22 Apr 2022) $
//
// Description: This file provides an RegisterSlic for an AXI4 stream Port.
//
// Notes:
// *********************************************************************/
`timescale 1ns / 1ns

module caxi4s_dwc_RegisterSlice #
(
...
generate
    ...
    begin
        ...
        caxi4s_dwc_RegSliceFull 
        #(
            .SYNC_RESET     (SYNC_RESET     ),
            .CHANNEL_WIDTH  (CHANNEL_WIDTH  )
         )
        caxi4s_dwc_RegSliceFull_inst
        (
            .aclk           (aclk           ),
            .resetn         (resetn         ),                      
...
endgenerate
endmodule       // caxi4s_dwc_RegisterSlice.v
