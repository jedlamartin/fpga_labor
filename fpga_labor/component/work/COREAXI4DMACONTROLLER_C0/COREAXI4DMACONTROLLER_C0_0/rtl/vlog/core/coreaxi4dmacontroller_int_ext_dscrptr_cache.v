...
//
// IP Core:      COREAXI4DMACONTROLLER_C0_COREAXI4DMACONTROLLER_C0_0_CoreAXI4DMAController_intExtDscrptrCache
...
//
// *********************************************************************/
module COREAXI4DMACONTROLLER_C0_COREAXI4DMACONTROLLER_C0_0_CoreAXI4DMAController_intExtDscrptrCache (
    // Inputs
    clock,
    resetn,
    ldDscrptr,
...
always @(posedge clock or negedge resetn)
   ...
   begin    
      ...
      begin	
	      COREAXI4DMACONTROLLER_C0_COREAXI4DMACONTROLLER_C0_0_ram_dscConCacheNM #(
	      	.WIDTH(13),
	      ...
	      COREAXI4DMACONTROLLER_C0_COREAXI4DMACONTROLLER_C0_0_ram_dscCacheNM #(
	      	.WIDTH(64),
	      	.DEPTH(NUM_OF_BDS_WIDTH)	
	      )
	      ...
	      COREAXI4DMACONTROLLER_C0_COREAXI4DMACONTROLLER_C0_0_ram_dscCacheM #(
	      	.WIDTH(88),
	      	.DEPTH(NUM_OF_BDS_WIDTH)	
	      )
