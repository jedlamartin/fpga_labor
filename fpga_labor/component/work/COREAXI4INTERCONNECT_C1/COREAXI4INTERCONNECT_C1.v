...
create_and_configure_core -core_vlnv {Actel:DirectCore:COREAXI4INTERCONNECT:2.9.100} -component_name {COREAXI4INTERCONNECT_C1} -params {\
"ADDR_WIDTH:64"  \
"CROSSBAR_MODE:0"  \
"DATA_WIDTH:64"  \
...
module COREAXI4INTERCONNECT_C1(
    // Inputs
    ACLK,
    ARESETN,
    MASTER0_ARADDR,
