...
#define DMA_CTRL_BASE_ADDR    0xE0010000UL

#define PROTOCONV_MM2S_CRTL_OFFSET 0x0410
#define PROTOCONV_MM2S_STS_OFFSET 0x0414
#define PROTOCONV_MM2S_LEN_OFFSET 0x0418
#define PROTOCONV_MM2S_ADDR0_OFFSET 0x041C

#define DMA_DESC0_CONFIG_OFFS 0x60
#define DMA_DESC0_BYTE_COUNT_OFFS 0x64
#define DMA_DESC0_SOURCE_ADDR_OFFS 0x68
#define DMA_DESC0_DEST_ADDR_OFFS 0x6C
#define DMA_DESC0_NEXT_DEST_ADDR_OFFS 0x70
